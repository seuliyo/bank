...
public class BankMain {
	public static void main(String[] args) {
		...
		// 6자리 정수형 랜덤 숫자 발생
		// valueOf()는 자바API에 있는 java.lang.String 클래스의
		...
		bank.openAccount("123-567", "아이언맨", "123", 5500);
		bank.openAccount("456-567", "헐크", "123", 3300);
		bank.openAccount("789-567", "스파이더", "123", 7700);
		bank.openAccount("999-567", "톰", "123", 6600);
	...
	/*
	 메소드 리팩토링 기법
	 : 복잡한 스파게티 소스를 가독성있게 분리시키고 
	   메소드를 재사용 할 수 있도록 모듈화 시키는 작업
	   ALT + SHIFT + M
	 */
	...
	private static void searchByName(Bank bank, Scanner scanner) {
		...
		// 디버깅 : 에러를 봤을 떄 데이터 값을 출력해보면서 버그를 잡아가는 것
